...
kubectl apply -f ingress_for_helloworld/gw.yaml
kubectl apply -f ingress_for_helloworld/service-example.yaml
kubectl apply -f ingress_for_helloworld/vs.yaml
